...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('SUPPORT', url="https://t.me/Contact_infinity_bot"), 
                    InlineKeyboardButton('UPDATES', url="https://t.me/infinitybm")
                ]]
    ...
    if len(message.command) != 2:
        ...
        await m.delete()
        m=await message.reply_sticker("CAACAgUAAxkBAAEMC1VmNK3M2OZV9bugtpzUy0fmE-ZigwACHgwAAv7nqVUKMgvLpPsd3jQE") 
        await asyncio.sleep(1)
        await m.delete()
